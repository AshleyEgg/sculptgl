var TR = {
  ...
  fileAdd: 'Add (rp obj ply stl zip)',
  ...
  sculptDrag: 'Drag',
  sculptPaint: 'Paint',
  sculptMasking: 'Masking',
  sculptMove: 'Move',
  sculptLocalScale: 'Local scale',
  sculptTransform: 'Move',
  sculptCircumference: 'Circumference',
  sculptAnteriorDepth: 'A/P Measurement',
  sculptLateralDepth: 'M/L Measurement',
  sculptScale: 'Scale',
  sculptPlaneCut: 'Plane Cut',
  sculptMirror: 'Mirror',
