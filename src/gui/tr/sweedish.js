var TR = {
  ...
  // file
  fileTitle: 'Filer (importera/exportera)',
  ...
  sculptCircumference: 'Omkrets',
  sculptAnteriorDepth: 'A/P Mått',
  sculptLateralDepth: 'M/L Mått',
  sculptScale: 'Skala',
  sculptPlaneCut: 'Skärplanet',
  sculptMirror: 'Återspegla',
